...
func bootlibDefaults(ctx android.LoadHookContext) {
...
func init() {
    android.RegisterModuleType("bootlib_defaults", bootlibDefaultsFactory)
}

func bootlibDefaultsFactory() android.Module {
    module := cc.DefaultsFactory()
    android.AddLoadHook(module, bootlibDefaults)
