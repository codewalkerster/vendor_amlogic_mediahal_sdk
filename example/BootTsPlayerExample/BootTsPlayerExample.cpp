...
int main(int argc, char **argv)
{
    ...
    AmTsPlayer_setParams(session, AM_TSPLAYER_KEY_BOOTPLAY_MODE , (void*)&bootplay_mode);
    ...
    #else
    if (mSurface && mProducerListener && mComposerClient && mControl) {
        mSurface.clear();
        mSurface = nullptr;
        mControl.clear();
        mControl = nullptr;
        mProducerListener.clear();
        mProducerListener = nullptr;
        mComposerClient.clear();
        mComposerClient = nullptr;
    }
    #endif
