...
#define AM_VIDEO_DEC_INIT_FLAG_USE_INPUT_BUFFER_POOL (1ul << 8)
#define AM_VIDEO_DEC_INIT_FLAG_USE_DYNAMIC_CAPTURE_BUFFER (1ul << 9)
#define AM_VIDEO_DEC_INIT_FLAG_USE_UVM               (1ul << 10)
#define AM_VIDEO_DEC_INIT_FLAG_USE_PTS_CALCULATOR    (1ul << 11)
